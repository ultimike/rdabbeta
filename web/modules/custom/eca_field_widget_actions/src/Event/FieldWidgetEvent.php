...
namespace Drupal\eca_field_widget_actions\Event;
 ...
 *
 * @package Drupal\eca_field_widget_actions\Event
 */
class FieldWidgetEvent extends Event {
   ...
   *
   * @param array|string $widgetValue
   *   The field widget value, or a list of suggested values.
   */
